        ...
        <LogcontentContainer>
            <LogcontentLeft>
                ...
                <LoginForm onSubmit={handleSubmit}>
                    <LoginEmail type="email" name="logindetail" value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Email or Emirates Skywards number"  />
                    ...
                    <Checkbox>
                        <KeepLogin type="checkbox" defaultChecked="true" onChange={(e) => setKeepLoggedIn(e.target.checked)}/>
