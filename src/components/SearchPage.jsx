    ...
    <>
        {
            ...
            (<>
                ...
                <AirportSummary>
                    <SummaryLeft>
                        <Detail>Return • {totalPassenger} passengers  • {classes} • <DetailSpan>Change search</DetailSpan></Detail>
                        <Detail>{departureDate}</Detail>
                        <Detail>{departure} to {arrival} </Detail>
                        <Detail>{returnDate} </Detail>
                        <Detail>{arrival} to {departure} </Detail>
                    </SummaryLeft>
